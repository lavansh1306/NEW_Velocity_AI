...
export default function AgentDashboard() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        // Get all ai_task_suggestions for this org
        ...
        // Last sync — most recent suggestion created_at
  ...
  const approvalRate = stats.totalSuggestions > 0
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-light text-gray-900 mb-1">Agent Status</h1>
        <p className="text-gray-500 text-sm font-light">
          How the AI agent is performing across your workspace
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <p className="text-3xl font-light text-gray-900">{stats.thisWeekSuggestions}</p>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">Approved</p>
          </div>
          <p className="text-3xl font-light text-gray-900">{stats.approvedSuggestions}</p>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <p className="text-3xl font-light text-gray-900">{stats.pendingSuggestions}</p>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">Last Sync</p>
          </div>
          <p className="text-sm font-light text-gray-900">
            {stats.lastSyncedAt
              ? new Date(stats.lastSyncedAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })
              : 'Never'}
          </p>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
        <h2 className="text-sm font-medium text-gray-900 mb-4">Overall Approval Rate</h2>
        <div className="flex items-center gap-4">
          ...
          <span className="text-sm font-medium text-gray-900 w-12 text-right">{approvalRate}%</span>
        </div>
        <p className="text-xs text-gray-400 mt-2">
          {stats.approvedSuggestions} approved out of {stats.totalSuggestions} total suggestions
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-sm font-medium text-gray-900">Most Frequently Matched Members</h2>
        </div>
        {stats.topMatchedMembers.length === 0 ? (
          <p className="text-sm text-gray-400">No data yet — sync your Google Workspace to get started.</p>
        ) : (
                ...
                <div className="flex-1">
                  ...
                  <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${Math.min((m.count / (stats.topMatchedMembers[0]?.count || 1)) * 100, 100)}%` }}
                    />
                  </div>
                </div>
              </div>
