...
const ModernDashboard = ({ jiraData }: { jiraData: any }) => {
  ...
  return (
    <div className="bg-[#FAFAF9] min-h-screen p-12 font-['Inter',sans-serif]">
      ...
      {/* Header Section */}
      <div>
        <h1 className="text-4xl font-light text-[#1C1917] mb-3 tracking-tight">Dashboard</h1>
        <p className="text-[#78716C] font-light text-base">Here's what's happening with your teams today.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm p-10 border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <div className="text-3xl font-bold text-[#0F766E]">{dashboardMetrics.availableCapacity}h</div>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <div className="text-3xl font-bold text-[#1C1917]">{dashboardMetrics.teamMembers}</div>
    ...
    <VelocityAISidebar>
      <div className="w-full h-full flex flex-col bg-[#F5F5F4] overflow-auto">
        ...
        <div className="flex-1 overflow-auto">
          <div className="px-8 py-6 max-w-7xl mx-auto animate-in fade-in duration-300">
            <style>{`
              .capacity-bar {
                height: 24px;
