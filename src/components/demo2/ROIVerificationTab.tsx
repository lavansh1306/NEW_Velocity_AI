export default function ROIVerificationTab() {
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">ROI Verification & Evidence Layer</h2>
        <p className="text-gray-600 mt-1">Tiered attribution • Traceable to source events • Realized value only</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg p-6 text-white">
          <div className="flex items-center justify-between mb-3">
            <div className="text-sm opacity-90">Tier A: Operational ROI</div>
            <span className="px-2 py-1 bg-white bg-opacity-20 rounded text-xs font-bold">Direct</span>
          </div>
          <div className="text-4xl font-bold mb-2">$68,200</div>
          <div className="text-sm opacity-75">12 verified accelerations</div>
          <div className="text-xs opacity-60 mt-2">Days Saved × CoD/day</div>
        </div>

        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg p-6 text-white">
          <div className="flex items-center justify-between mb-3">
            <div className="text-sm opacity-90">Tier B: Cost Avoidance</div>
            <span className="px-2 py-1 bg-white bg-opacity-20 rounded text-xs font-bold">Validated</span>
          </div>
          <div className="text-4xl font-bold mb-2">$42,500</div>
          <div className="text-sm opacity-75">8 harvest tasks completed</div>
          <div className="text-xs opacity-60 mt-2">Contractor/headcount reduction</div>
        </div>

        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg p-6 text-white">
          <div className="flex items-center justify-between mb-3">
            <div className="text-sm opacity-90">Tier C: Revenue Impact</div>
            <span className="px-2 py-1 bg-white bg-opacity-20 rounded text-xs font-bold">Attributed</span>
          </div>
          <div className="text-4xl font-bold mb-2">$16,750</div>
          <div className="text-sm opacity-75">3 deal accelerations</div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
        <h3 className="text-lg font-bold text-gray-900 mb-4">Evidence Trail</h3>
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4 border-l-4 border-green-500">
            <div className="flex items-start justify-between mb-3">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-bold text-gray-900">Q4 Campaign Launch Acceleration</span>
                </div>
                <div className="text-sm text-gray-600">Marketing Operations • Completed Nov 8, 2024</div>
              </div>
            ...
            <details className="text-xs">
              ...
              <div className="bg-white p-3 rounded border border-gray-200 space-y-1 text-gray-600">
            ...
            <div className="flex items-start justify-between mb-3">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-bold text-gray-900">Lead Triage Automation - Contractor Reduction</span>
                </div>
                <div className="text-sm text-gray-600">Marketing Operations • Oct 2024 - Ongoing</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-gray-500">Validated Savings</div>
                <div className="text-2xl font-bold text-orange-600">$18,200</div>
              </div>
            </div>
            <div className="grid grid-cols-4 gap-4 text-sm mb-3">
              <div>
            ...
            <div className="flex items-start justify-between mb-3">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-bold text-gray-900">Enterprise Deal Velocity - POC Support</span>
                </div>
                <div className="text-sm text-gray-600">Sales Engineering • Deal closed Nov 4, 2024</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-gray-500">Attributed Value</div>
                <div className="text-2xl font-bold text-purple-600">$9,000</div>
              </div>
            </div>
            <div className="grid grid-cols-4 gap-4 text-sm mb-3">
              <div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <h3 className="text-lg font-bold text-blue-900 mb-4">90-Day Pilot Exit Criteria</h3>
        <div className="grid grid-cols-3 gap-6">
          <div className="bg-white rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-bold text-gray-900">Verified ROI</span>
            </div>
            <div className="text-sm text-gray-600 mb-1">Target: $40,000</div>
          ...
          <div className="bg-white rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-bold text-gray-900">Evidence Depth</span>
            </div>
            <div className="text-sm text-gray-600 mb-1">Required: 2+ tiers</div>
            <div className="text-2xl font-bold text-green-600">3 Tiers</div>
          ...
          <div className="bg-white rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-bold text-gray-900">Security Audit</span>
            </div>
            <div className="text-sm text-gray-600 mb-1">Read-only scope verified</div>
            <div className="text-sm font-bold text-green-600">Passed</div>
