      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg flex items-center justify-center text-white font-bold text-sm sm:text-lg">
              V
            </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3 ml-auto">
            ...
            <div className="hidden sm:flex items-center gap-2 bg-green-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="h-8 sm:h-10 flex items-center gap-1 sm:gap-2 px-2 sm:px-3 bg-white border border-gray-200 rounded-lg text-xs sm:text-sm hover:shadow-sm">
                  <Settings className="h-3 w-3 sm:h-4 sm:w-4 text-gray-700" />
            ...
            <button className="h-8 sm:h-10 px-2 sm:px-4 text-xs sm:text-sm bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition">
