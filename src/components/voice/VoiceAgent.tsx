...
/**
 * VoiceAgent — visual orb only.
 * Transcript processing and Ctrl+Space are handled by GlobalVoiceCommander.
 * This component only shows the floating orb indicator in the bottom right.
 */
export const VoiceAgent: React.FC = () => {
  const { isListening, status, lastTranscript, isTriggered, volumeLevel, startListening, stopListening } = useVoice();
  ...
  return (
    ...
    >
      {/* Main Orb Button — click to open GlobalVoiceCommander */}
      <div
